      ...
      <div className="container px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="relative p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 bg-card border-border hover:border-primary/50">
